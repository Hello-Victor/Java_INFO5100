...
public class AccountDirectory {
    ...
    public void modifyAccountName(Account account, String newUserName) {
        String oldUserName = account.getUserName();
        account.setUserName(newUserName);
        Profile profile = accountProfileMap.get(oldUserName);
        java.lang.Class profileClass = accountRoleMap.get(oldUserName);
        accountProfileMap.remove(account.getUserName());
        accountRoleMap.remove(account.getUserName());
        accountProfileMap.put(newUserName, profile);
        accountRoleMap.put(newUserName, profileClass);
    }
}
