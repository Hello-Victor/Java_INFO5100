 ...
 * @author victor
 */
public class PersonalInformation extends BaseJPanel {
     ...
     */
    public PersonalInformation(JPanel mainWorkArea, Profile loginProfile) {
        super(mainWorkArea);
        this.profile = loginProfile;
        this.loginPerson = loginProfile.getPerson();
        initComponents();
        refreshTable();
    ...
    public void refreshTable() {
        jTextField5.setText(loginPerson.getId());
        jTextField1.setText(loginPerson.getLastname());
        jTextField4.setText(loginPerson.getBirthDateString());
        jTextField2.setText(loginPerson.getPhoneNumberString());
        jTextField3.setText(loginPerson.getAddress());
        jTextField6.setText(profile.getAccount().getUserName());
        jPasswordField1.setText(profile.getAccount().getPassword());
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String user;
        try {
            birthdate = dateFormat.parse(jTextField4.getText());
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Wrong Date Format! should be yyyy-MM-dd");
            return;
        }
        try {
            accountDirectory.modifyAccountName(profile.getAccount(), jTextField6.getText(), String.valueOf(jPasswordField1.getPassword()));
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Account name conflict!");
            return;
        }
        loginPerson.setLastname(jTextField1.getText());
        loginPerson.setBirthDate(birthdate);
        loginPerson.setPhoneNumberString(jTextField2.getText());
        loginPerson.setAddress(jTextField3.getText());
