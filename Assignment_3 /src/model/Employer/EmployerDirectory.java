...
public class EmployerDirectory {
    ...
    public EmployerDirectory(Company cmp) {
        company = cmp;
    }

    public EmployerProfile newEmployerProfile(Person p, String userName, String password) throws AccountDirectory.AccountNameConflictException {
        EmployerProfile ep = new EmployerProfile(p, company);
