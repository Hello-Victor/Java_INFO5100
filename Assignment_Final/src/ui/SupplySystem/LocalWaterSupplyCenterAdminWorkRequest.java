 ...
 * @author 73110
 */
public class LocalWaterSupplyCenterAdminWorkRequest extends BaseJPanel {
    ...
    public LocalWaterSupplyCenterAdminWorkRequest(JPanel mainWorkArea) {
        super(mainWorkArea);
        initComponents();
    ...
    public void refresh() {
        populateTable();
        jLabel22.setText(address.getAddress());
    }

    private void populateTable() {
        DefaultTableModel model = (DefaultTableModel) tblUsers.getModel();
        model.setRowCount(0);
        for (Employee p : waterOrganization.getEmployeeDirectory().getavailableIterator()) {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Create Water Supply Request");
        ...
        jRadioButton1.setText("water On");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("water Off");
        ...
        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/images/location_48px.png"))); // NOI18N
        jLabel23.setText("Set location");
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        WaterRequest workRequest = new WaterRequest();
        workRequest.setReceiver(waterOrganization);
