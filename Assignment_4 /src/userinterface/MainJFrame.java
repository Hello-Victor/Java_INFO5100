...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        String inUsername = userNameJTextField.getText();
        String inPassword = passwordField.getText();
        for (UserAccount userAccount : userAccountList) {
            //快递员或者客户登录
            if (userAccount.getUsername().equals(inUsername) && userAccount.getPassword().equals(inPassword)) {
        ...
        if (loginUserAccount == null) {
            ...
            for (Restaurant restaurant : restaurants) {
                ArrayList<UserAccount> tmpuserAccountList = restaurant.getUserAccountDirectory().getUserAccountList();
                for (UserAccount userAccount : tmpuserAccountList) {
                    //餐厅老板登录
                    if (userAccount.getUsername().equals(inUsername) && userAccount.getPassword().equals(inPassword)) {
                        loginUserAccount = userAccount;
        ...
        LoginSession.mainWorkArea = container;
        LoginSession.restaurant=loginRestaurant;
        LoginSession.userAccout=loginUserAccount;
        
        Role role = loginUserAccount.getRole();
        
        JPanel createWorkArea = role.createWorkArea(container, loginUserAccount, system);
        nextPanel(createWorkArea);
